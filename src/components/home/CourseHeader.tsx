...
const CourseHeader = () => {
  return (
    <motion.div 
      ...
      className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 sm:p-8 lg:p-10 mb-12"
    >
      {/* Breadcrumb */}
      <motion.div 
      ...
      <div className="flex flex-col lg:flex-row items-start gap-6 lg:gap-8">
        <motion.div 
          ...
          className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-5 rounded-2xl shadow-lg flex-shrink-0"
        >
          <BookOpen className="w-12 h-12 lg:w-14 lg:h-14 text-white" />
        </motion.div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <motion.p 
            ...
            className="text-gray-600 leading-relaxed mb-6 text-base lg:text-lg"
          >
